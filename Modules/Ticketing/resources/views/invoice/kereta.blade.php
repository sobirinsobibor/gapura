    ...
    <table class="tg" style="margin-top: 12px; margin-bottom: 12px; font-weight: 700; font-family: 'Roboto', sans-serif;">
        ...
        <tbody style="font-weight: normal; padding: 0px;">
            <tr style="font-weight: 700;">
                ...
                <td class="" style="text-align: center; width: 15%" colspan="3">
                    Route
                </td>
                <td class="" style="text-align: center">Date</td>
                <td class=""></td>
            </tr>
            @foreach ($penumpangs as $index => $penumpang)
                <tr>
                    <td class="" style="text-align: center; font-weight: 400;padding:0">
                    ...
                    <td class="" colspan="3">
                        <span>{{ $rute_kereta }}</span>
                    </td>
                    <td class="">
                        <span>{{ date('d-M-y H:i', strtotime($jadwal_berangkat_kereta)) }}</span>
                    </td>
                    <td class="">
